...
class Final(Node):
    ...
    def __init__(self):
        ...
        self.timer = self.create_timer(0.1, self.super_control_loop)
    ...
    control_pos = 0
    timer = 0
    def super_control_loop(self) -> None:
        ...
        # Check for any april tags
        #if april_tag detected:
            #self.control_pos = 1

        if self.control_pos == 0: # No april Tag detected
            self.follow_line()
